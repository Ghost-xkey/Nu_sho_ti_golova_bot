...
class GrishaPhotoCommenter:
    ...
    def __init__(self):
        ...
        self.scenario_templates = {
            'fishing': [
                ...
                "Рыба умная — не клюёт на твои истории",
                "Улов в мечтах, пустота в садке — классика жанра",
                "Рыбак с удочкой, рыба с чувством юмора",
                "Вода мутная, как твои планы на выходные",
                "Рыба видит тебя и думает: 'Ну и клоун же'"
            ],
            'male_group': [
                ...
                "Мужская компания: все умные, никто не слушает",
                "Пацаны собрались — IQ коллективно упал",
                "Братишки в деле. Логика — в отпуске",
                "Мужской разговор: много слов, мало смысла",
                "Команда боевая, мозги — в резерве",
                "Пацаны как один — все одинаково не правы"
            ],
            'female_group': [
                ...
                "Девчонки в деле — мужчины в панике",
                "Красота зашкаливает, логика — в отпуске",
                "Команда мечты: все красивые, никто не спорит",
                "Девушки собрались — планета замерла",
                "Красота коллективная, мозги — индивидуальные",
                "Стиль на максимум, скромность — в резерве"
            ],
            'mixed_group': [
            ...
            'work': [
                "Работа кипит, мозги — в отпуске",
                "Офисная жизнь: много планов, мало результатов",
                "Коллеги собрались — продуктивность упала",
                "Рабочий процесс: все заняты, никто не работает",
                "Команда сильная, дедлайны — в панике",
                "Офис как семья: все друг друга терпят",
                "Работаем дружно, эффективность — отдельно",
                "Коллеги в деле — здравый смысл в отпуске"
            ],
            'study': [
                "Учёба идёт, знания — как получится",
                "Студенты собрались — IQ коллективно упал",
                "Образование в процессе, мозги — в резерве",
                "Учимся дружно, понимаем — по-разному",
                "Знания накапливаются, логика — отдыхает",
                "Студенческая жизнь: много планов, мало сна",
                "Учёба кипит, здравый смысл — в отпуске"
            ],
            'sport': [
                "Спорт идёт, координация — как получится",
                "Команда боевая, техника — в разработке",
                "Тренируемся дружно, результаты — отдельно",
                "Спортсмены в деле — гравитация в панике",
                "Физическая форма есть, умственная — в планах",
                "Спорт объединяет, логика — разъединяет",
                "Тренировка идёт, самооценка — растёт"
            ],
            'travel': [
                "Путешествие началось, планы — в разработке",
                "Туристы в деле — местные в панике",
                "Едем дружно, понимаем — по-разному",
                "Дорога объединяет, навигация — разъединяет",
                "Путешествуем активно, логика — пассивно",
                "Туризм идёт, культура — в шоке",
                "Дорога зовёт, здравый смысл — остаётся"
            ],
            'default': [
                ...
                "Фото получилось, жизнь — посмотрим",
                "Кадр живой, персонаж — спорный",
                "Снято с душой, логика — в отпуске"
            ]
        }
        ...
        self.comment_variants = {
            'selfie': [
                ...
                "Селфи как жизнь: много попыток, один результат",
                "Лицо в кадре, мозги — в отпуске",
                "Селфи удалось, теперь бы с личностью так же",
                "Камера терпит, мы держимся",
                "Селфи бодрое, самооценка — в панике",
                "Лицо есть, харизма — в разработке",
                "Селфи как анекдот: либо смешно, либо грустно",
                "Камера не лжёт, но и не говорит всей правды"
            ],
            'food': [
            ...
            'group': [
                ...
                "Группа собралась — IQ коллективно упал",
                "Команда боевая, логика — в отпуске",
                "Все улыбаются, кто-то уже жалеет",
                "Групповое фото: много лиц, мало смысла",
                "Команда сильная, дисциплина — в планах",
                "Людей много, идей — как получится",
                "Группа в деле — здравый смысл в панике",
    ...
    def detect_scenarios(self, analysis: Dict[str, Any]) -> list:
        ...
        # Работа / учёба / спорт / путешествия
        if has_any(['office', 'workplace', 'meeting', 'conference', 'business', 'corporate', 'desk', 'computer', 'laptop', 'presentation']):
            add('work')
        if has_any(['school', 'university', 'college', 'classroom', 'library', 'study', 'student', 'education', 'book', 'exam']):
            add('study')
        if has_any(['sport', 'football', 'soccer', 'basketball', 'tennis', 'gym', 'fitness', 'training', 'match', 'competition', 'stadium']):
            add('sport')
        if has_any(['travel', 'vacation', 'trip', 'airport', 'hotel', 'suitcase', 'passport', 'tourist', 'sightseeing', 'adventure']):
            add('travel')
