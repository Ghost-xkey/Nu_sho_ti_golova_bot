...
class YandexGPT:
    ...
    def generate_response(self, message_text: str, chat_id: str, username: str = None) -> Optional[str]:
        ...
        try:
            ...
            short_messages = ["бот", "привет", "хай", "да", "нет", "ок", "окей", "понятно", "ясно", "спасибо", "спс"]
            ...
            # Исключаем простые и неинформативные сообщения
            should_engage = (needs_support or wants_conversation or is_detailed_message) and not is_simple_response
            ...
            # Но только если сообщение не является простым ответом
            if not should_auto_respond and not is_meme_request and is_continuing_conversation and not is_simple_response:
            ...
            if not should_auto_respond and not is_meme_request and random.random() < 0.5:
                should_auto_respond = True
